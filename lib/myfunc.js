...
exports.serialize = (lexxy, msg) => {
    ...
    try{
        ...
        msg.quotedMsg.fromMe = msg.quotedMsg.sender === lexxy.user.id.split(':')[0]+'@s.whatsapp.net' ? true : false
    ...
    if (msg.key.fromMe){
        msg.sender = lexxy.user.id.split(':')[0]+'@s.whatsapp.net'
    }
